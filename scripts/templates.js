...
function header(todos){
    let done = (todos.filter(function(todo) {
  ...
  <div class="header__content">
    ...
    <div class="header__counter">
      <p id="copmleted-counter">${done}</p>
      <p>/</p>
      <p id='counter'>${todos.length}</p>
    </div>
  </div>
  <svg class="header__line" height="45px">
  <line x1="3%" y1="25" x2="97%" y2="25" stroke="white" opacity="0.5" stroke-linecap="round" stroke-width="15"/>
  <line x1="3%" y1="25" x2="${done?done/todos.length*100-3:1}%" y2="25" stroke-linecap="round" stroke="white" stroke-width="${done?15:0}"/>
 </svg>
